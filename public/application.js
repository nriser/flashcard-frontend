...
/***/ (function(module, exports, __webpack_require__) {
	...
	var flashcardEvents = __webpack_require__(35);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var flashcardapi = __webpack_require__(13);
	var flashcardui = __webpack_require__(14);
	...
	var signUpSuccess = function signUpSuccess(response) {
	  ...
	  flashcardapi.getFlashcards().then(flashcardui.getFlashcardsSuccess).catch(flashcardui.getFlashcardsFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// CREATE
	var createFlashcard = function createFlashcard(data) {
	  return $.ajax({
	    method: 'POST',
	...
	// GET
	var getFlashcards = function getFlashcards() {
	  return $.ajax({
	    method: 'GET',
	    url: config.apiOrigin + '/flashcards/',
	    headers: {
	...
	// PATCH
	var updateFlashcard = function updateFlashcard(data) {
	  return $.ajax({
	    method: 'PATCH',
	    url: config.apiOrigin + '/flashcards/' + data.flashcard.id,
	    headers: {
	...
	// DELETE
	var deleteFlashcard = function deleteFlashcard(data) {
	  return $.ajax({
	    method: 'DELETE',
	    url: config.apiOrigin + '/flashcards/' + data.flashcard.id,
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showFlashcardsTemplate = __webpack_require__(15);
	var api = __webpack_require__(13);
	var getFormFields = __webpack_require__(9);

	var createFlashcardSuccess = function createFlashcardSuccess(response) {
	...
	var createFlashcardFailure = function createFlashcardFailure() {
	  $('#delete-flashcard').empty();
	  $('#content-status-message').text('Please enter a word and a definition.');
	};

	var getFlashcardsSuccess = function getFlashcardsSuccess(response) {
	  // store.flashcard = response.flashcard // store the flashcard object in user object (store)
	  var showFlashcardsHtml = showFlashcardsTemplate({ flashcards: response.flashcards });
	...
	var getFlashcardsFailure = function getFlashcardsFailure() {
	  $('#content-status-message').text('Something went wrong. Please try again.');
	};

	var onDeleteFlashcard = function onDeleteFlashcard(event) {
	  event.preventDefault();
	...
	var createDataObject = function createDataObject(flashcardId) {
	  var data = {
	    flashcard: {
	      id: flashcardId
	    }
	  ...
	  event.preventDefault();
	  api.deleteFlashcard(data).then(deleteFlashcardSuccess).catch(deleteFlashcardFailure);
	};

	var onUpdateFlashcard = function onUpdateFlashcard(event) {
	  event.preventDefault();
	  ...
	  api.updateFlashcard(data).then(updateFlashcardSuccess).then(function () {
	    api.getFlashcards().then(getFlashcardsSuccess).catch(getFlashcardsFailure);
	  }).catch(updateFlashcardFailure);
	};

	var updateFlashcardSuccess = function updateFlashcardSuccess() {
	...
	var updateFlashcardFailure = function updateFlashcardFailure() {
	  $('#content-status-message').text('Please enter a word, definition, and a valid card ID.');
	};

	var deleteFlashcardSuccess = function deleteFlashcardSuccess() {
	  // $('#content-status-message').text('Card updated successfully')
	};

	var deleteFlashcardFailure = function deleteFlashcardFailure() {
	  $('#content-status-message').text('Something went wrong. Please try again.');
	};
	...
	module.exports = {
	  createFlashcardSuccess: createFlashcardSuccess,
	  createFlashcardFailure: createFlashcardFailure,
	  // getFlashcardSuccess,
	  // getFlashcardFailure,
	  getFlashcardsSuccess: getFlashcardsSuccess,
	  getFlashcardsFailure: getFlashcardsFailure,
	  updateFlashcardSuccess: updateFlashcardSuccess,
	  updateFlashcardFailure: updateFlashcardFailure,
	  deleteFlashcardSuccess: deleteFlashcardSuccess,
	  deleteFlashcardFailure: deleteFlashcardFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n    <div id=\"card-container\" class=\"card-container\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n      <div id=\"flip-container\" class=\"flip-container\" ontouchstart=\"this.classList.toggle('hover')\">\n\n        <div class=\"flipper\">\n          <div id=\"flip-front\" class=\"flip-front card\">\n            <p id=\"flip-front-text\" class=\"flip-front-text\">\n              "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.word : stack1), depth0))
	    + "\n            </p>\n          </div>\n\n          <div id=\"flip-back\" class=\"flip-back card\">\n            <p id=\"flip-back-text\" class=\"flip-back-text\">\n              "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.definition : stack1), depth0))
	    + "\n            </p>\n          </div>\n        </div>\n      </div>\n\n      <audio controls\n      src=\"https://api.voicerss.org/?key=1d3b94873d76490aa642c3b7dce52146&hl=ja-jp&src="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.word : stack1), depth0))
	    + "\" class=\"word-audio\" id=\"word-audio\">\n      Your browser does not support the <code>audio</code> element.\n      </audio>\n\n      <!-- <form id=\"updateFlacards\" class=\"text-align-center updated-flashcard\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <fieldset>\n          <input class=\"card-front-text update-front-text\" type=\"text\" name=\"flashcard[word]\" placeholder=\"Enter a word\">\n          <input class=\"card-back-text update-back-text\" type=\"text\" name=\"flashcard[definition]\" placeholder=\"Enter a definition\">\n          <input class=\"update-submit\" type=\"submit\" name=\"submit\" value=\"Update Card\">\n        </fieldset>\n      </form> -->\n\n      <!-- Trigger the modal with a button -->\n      <button type=\"button\" class=\"modal-btn modal-update-button\" data-toggle=\"modal\" data-target=\"#modal-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <span class=\"glyphicon glyphicon-edit\" aria-hidden=\"true\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"></span>\n      </button>\n      <!-- Modal -->\n      <div id=\"modal-update\" class=\"modal fade modal-update\" role=\"dialog\">\n        <div class=\"modal-dialog\">\n          <!-- Modal content-->\n          <div class=\"modal-content\">\n            <!-- Modal header-->\n            <div class=\"modal-header\">\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n              <h4 class=\"modal-title\">Update</h4>\n            </div>\n            <!-- Modal body-->\n            <div class=\"modal-body\">\n              <form id=\"updated-flashcard\" class=\"text-align-center updated-flashcard\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                <fieldset>\n                  <input class=\"card-front-text update-front-text\" type=\"text\" name=\"flashcard[word]\" placeholder=\"Enter a word\">\n                  <input class=\"card-back-text update-back-text\" type=\"text\" name=\"flashcard[definition]\" placeholder=\"Enter a definition\">\n                  <input class=\"update-submit\" type=\"submit\" name=\"submit\" value=\"Update Card\">\n                </fieldset>\n              </form>\n            </div>\n            <!-- Modal footer-->\n            <div class=\"modal-footer\">\n              <p id=\"update-status-message\" class=\"update-status-message text-align-center\"></p>\n              <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <button id=\"delete-flashcard\" class=\"delete-flashcard\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return "<div id=\"card-response\" class=\"card-response\">\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.flashcards : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n</div>\n\n<!-- Key 1 -->\n<!-- <audio controls\nsrc=\"https://api.voicerss.org/?key=dc0066763bea477f8b68c2a50bc8bbf8&hl=ja-jp&src="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.flashcard : depth0)) != null ? stack1.word : stack1), depth0))
	    + "\" class=\"word-audio\" id=\"word-audio\">\nYour browser does not support the <code>audio</code> element.\n</audio> -->\n\n<!-- Key 2 -->\n<!-- <audio controls src=\"https://api.voicerss.org/?key=cb75676b142f4d9ea40f9082ad50731b&hl=ja-jp&src="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.flashcard : depth0)) != null ? stack1.word : stack1), depth0))
	    + "\" class=\"word-audio\" id=\"word-audio\">\nYour browser does not support the <code>audio</code> element.\n</audio> -->\n\n<!-- Key 3 -->\n<!-- <audio controls\nsrc=\"https://api.voicerss.org/?key=1d3b94873d76490aa642c3b7dce52146&hl=ja-jp&src="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.flashcard : depth0)) != null ? stack1.word : stack1), depth0))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateFlashcard = function onCreateFlashcard(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createFlashcard(data).then(ui.createFlashcardSuccess).catch(ui.createFlashcardFailure);
	};
	...
	var onGetFlashcards = function onGetFlashcards(event) {
	  event.preventDefault();
	  api.getFlashcards().then(ui.getFlashcardsSuccess).catch(ui.getFlashcardsFailure);
	...
	var onClickUpdateButton = function onClickUpdateButton() {
	...
	var onClickCreateButton = function onClickCreateButton() {
	...
	var addFlashcardHandlers = function addFlashcardHandlers() {
	...
	module.exports = {
	  addFlashcardHandlers: addFlashcardHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "3c724e5abc3d68836bdad30c06f2b458.jpg";

/***/ }),
/* 45 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "635dae6e41c9a53398da31791a9a37a9.jpg";
